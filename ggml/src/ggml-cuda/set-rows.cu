...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    if (dst->type == GGML_TYPE_F32) {
    ...
    } else if (dst->type == GGML_TYPE_TQ2_0) {
        set_rows_cuda_quant<idx_t, block_tq2_0, QK_TQ2_0, quantize_f32_tq2_0_block>(
            src0_d, src1_d, (block_tq2_0*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
    ...
    } else if (dst->type == GGML_TYPE_TQ4_0) {
        set_rows_cuda_quant<idx_t, block_tq4_0, QK_TQ4_0, quantize_f32_tq4_0_block>(
            src0_d, src1_d, (block_tq4_0*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
        ...
        set_rows_cuda_quant<idx_t, block_iso3_0, QK_ISO3_0, quantize_f32_iso3_0_block>(
        ...
        set_rows_cuda_quant<idx_t, block_iso4_0, QK_ISO4_0, quantize_f32_iso4_0_block>(
