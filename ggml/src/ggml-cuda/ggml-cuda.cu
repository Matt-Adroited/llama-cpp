        ...
        case GGML_OP_SET_ROWS:
            {
                return (op->type == GGML_TYPE_F32 || op->type == GGML_TYPE_F16 || op->type == GGML_TYPE_BF16 ||
                       ...
                       op->type == GGML_TYPE_TQ2_0 || op->type == GGML_TYPE_TQ3_0 || op->type == GGML_TYPE_TQ4_0 ||
                       op->type == GGML_TYPE_ISO3_0 || op->type == GGML_TYPE_ISO4_0) &&
        ...
        case GGML_OP_CPY:
            {
                ...
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_TQ2_0) {
                    return true;
                }
                if (src0_type == GGML_TYPE_TQ2_0 && src1_type == GGML_TYPE_F32) {
                    return true;
                }
                ...
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_TQ4_0) {
                    return true;
                }
                if (src0_type == GGML_TYPE_TQ4_0 && src1_type == GGML_TYPE_F32) {
                    return true;
                }
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_ISO3_0) {
                    return true;
                }
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_ISO4_0) {
                    return true;
                }
