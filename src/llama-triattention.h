...
//
// v1 scope (this port):
//   - Dense KV types only: F32 / F16 / Q8_0
//   - Standard RoPE models (Llama, Qwen, Mistral, Gemma) — half + interleaved
//   - GPU-first (HIP/CUDA scoring kernel); CPU path is fallback only
//
// v2 deferred:
//   - TurboQuant (TQ2_0/TQ3_0/TQ4_0) requires cooperative WHT inverse
//   - IsoQuant-Fast (ISO3_0/ISO4_0) requires quaternion inverse rotation
//   - Kimi-Linear MLA (partial RoPE, latent KV)
